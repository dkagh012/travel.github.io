    ...
    (a.prototype = {
      ...
      updateElement: function () {
        if (this.element.is("input") && this.autoUpdateInput) {
          var t = this.startDate.format("YYYY-MM-DD"); // Updated date format
          if (this.endDate) {
            var e = this.endDate.format("YYYY-MM-DD"); // Updated date format
          } else {
            var e = ""; // Set e to an empty string when endDate is null
          }

          this.singleDatePicker || (t += this.locale.separator + e); // Updated date format
